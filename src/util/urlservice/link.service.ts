...
export class LinkService extends ExceptionService {
    ...
    public getLinksMock(): UrlEndPoint {
        ...
        // Mock QA
        return JSON.parse('{"endpoints":[{"nome":"customerAPI","url":"http://10.40.196.172:7171/customerAPI/"},{"nome":"fulltestAPI","url":"http://10.40.196.172:7172/fulltestAPI/"},{"nome":"stealerAPI","url":"http://10.40.198.168:7173/stealerAPI/"},{"nome":"authAPI","url":"http://10.40.196.172:7176/authAPI/"},{"nome":"dmsAPI","url":"http://10.200.35.67:80/dmsAPI/"},{"nome":"acs","url":"http://10.40.196.172:7177/acsAPI/"}]}');
    }
}